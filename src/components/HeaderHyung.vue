<template>
  ...
  <header class="header-section">
    <div class="header-top">
      <div class="container">
        <div class="ht-left">
          <div class="mail-service"><i class=" fa fa-envelope"></i> hyung@gmail.com</div>
          <div class="phone-service"><i class=" fa fa-phone"></i> +62 81383931804</div>
        </div>
      </div>
    </div>
    <div class="container">
                ...
                <div class="cart-hover">
                  ...
                  <div class="select-button">
                    <a href="#" class="primary-btn view-card">
                      <router-link to="/shopping" style="color: #FFF;">VIEW CARD</router-link>
                    </a>
